...
This script asks the user to enter profile information, interests, and preferences, then organizes the information into separate folders and text files. Finally, it displays the social network feed by reading the text files.

When you run the script, it will create a new directory called FamSocialNetwork with subdirectories for each user's profile, interests, and preferences. The output will look something like this:
Social Network Feed:
PROFILE:
Name: John
Date: 2024-07-25
